            ...
            <div class="main">
                <div class="title" style="text-align: center;">
                    <el-menu
                        ...
                        @select="handleSelect"
                    >
                        <el-menu-item class="de" index="1">
                            我的资料
                        </el-menu-item>
                        <el-menu-item class="de" index="2">
                            我的订单
                        </el-menu-item>
                        <el-menu-item class="de" index="3">
                            消息中心
                        </el-menu-item>
                        <el-menu-item class="de" index="4">
                            我的题库
                        </el-menu-item>
                    </el-menu>
                </div>
                ...
                >
                    <div
                        v-if="topnum === 1"
                        class="content yx-center userinfo al-str"
                    >
                        <div class="info">
                            <el-form
                                ref="formData"
                            ...
                            >
                                <!-- 个人资料 -->
                                <div
                                    class="myinformation userinfo-row yx-between al-str box-root"
                                >
                                    <div
                                        ...
                                        "
                                        @click="
                                            headerOpenData.info = !headerOpenData.info
                                        "
                                    >
                                        ...
                                        <div class="op pointer">
                                            ...
                                            <img
                                                v-else
                                                src="../../resouce/userindex/down.png"
                                            />
                                        </div>
                                    </div>
                                    <transition
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                class="userinfo-detail-row xy-between full-width"
                                            >
                                                <label>昵称：</label>
                                                <div
                                ...
                                >
                                    <div
                                        ...
                                        "
                                        @click="
                                            headerOpenData.head = !headerOpenData.head
                                        "
                                    >
                                        <div class="i-xy-between jf-start left">
                            ...
                            >
                                ...
                                >
                                    <div
                                        ...
                                        "
                                        @click="
                                            headerOpenData.pass = !headerOpenData.pass
                                        "
                                    >
                ...
                <div v-if="topnum === 2" class="content order-box">
                    <div
                        ...
                        :infinite-scroll-disabled="
                            orderNoMore || flag.loadOrderFlag
                        "
                    >
                        <transition
                        ...
                        >
                            <div
                                v-if="order.show"
                                class="i-yx-between al-str full-width listItem"
                            >
                                <div class="orderTop">
                                    <div
                                        class="order-state"
                                ...
                                <div
                                    class="order-body xy-between al-str jf-start"
                                >
                                    ...
                                    <div class="i-yx-between sn al-start">
                                        <div class="order-sn yx-center">
                                            订单号：{{ order.orderId }}
                                        </div>
                                        <div class="setmealName yx-center">
                                            {{ order.setmealName }}
                                        </div>
                                    </div>
                                ...
                                <div
                                    ...
                                    class="xy-between b-btn"
                                >
                                    <el-button
                                        type="primary"
                                        @click="clickPay(order.orderId)"
                                    >
                                        去结算
                                    </el-button>
                                    <el-button
                    ...
                    <div
                        v-if="flag.loadOrderFlag"
                        class="xy-center order-scr back-fff-box"
                    >
                        加载中
            ...
            >
                <div v-if="topnum === 3" class="content order-box">
                    <div
                        ...
                        class="list"
                        :infinite-scroll-disabled="
                            messageNoMore || flag.loadMessageFlag
                        "
                    >
                        <div class="newsItem">
                            <transition
                                ...
                                >
                                    ...
                                    <div class="i-yx-between al-start right">
                                        <div class="head i-xy-center jf-start">
                                            <div class="memssageName">
                                                {{ message.memssageName }}
                                            </div>
        ...
        loadOrders() {
            flagPromise
                ...
                .then(r => {
                    ...
                    console.log(this.orders, 13322222222222222)
                    this.orders.push(
                        ...r.map(o => {
                            return {
                                ...o,
