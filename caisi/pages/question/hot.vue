...
import { Hot, Collection, submiterror, getHotErrTest } from "../action";
...
export default {
    ...
    watch: {
        ...
        "state.userchoseInfor.id"(kmid) {
            ...
            //             if (
            //                 this.$route.query.questionId === res[i].questionId
            //             ) {
            //                 this.num = i;
    ...
    methods: {
        async getQuestionDetail(questionId) {
            ...
            let questionDetail = await Hot(questionId);
        ...
        // async prev() {
        //     this.num = this.num - 1;
        //     this.currentQuestion = await this.getQuestionDetail(
        //         this.ErrList[this.num].id
        //     );
        // },
        // async next() {
        //     // 下一题
        //     // let testNum = this.hotList.length - 1;
        //     // this.testNum = testNum;
        //     // console.log(this.num, "当前题目数");
        //     // console.log(testNum, "最后的题目数");
        //     // if (this.num >= testNum) {
        //     //     return false;
        //     // }
        //     this.num = this.num + 1;
