            ...
            <div v-if="flag" class="main">
                <div class="stem">
                    ...
                    <div v-if="ShowType==0" class="mainLeft">
                        <div class="pageTitle">我的收藏回顾</div>
                        <div class="stem">
                            <span class="questiontype">{{ num+1 }}.</span>
                            <span v-html="collList[num].stem" />
                        </div>
                        <div class="content">
                            <!-- 单选和判断-->
                            <div
                                v-if="collList[num].questionType.type==0"
                            >
                                <div v-if="collList[num].userAnswer==null">
                                    <div
                                        v-for="(item,n) in collList[num].answerList"
                                        :key="n"
                                        class="singlecontent"
                                    >
                                        <div>
                                ...
                                <div v-else-if="collList[num].userAnswer!=''">
                                    <div
                                        v-for="(item,n) in collList[num].answerList"
                                        :key="n"
                                        class="singlecontent"
                                    >
                                        <div>
                                            <span
                                                class="chose"
                                                :class="[item.rightFlag==1?'leftchose':'',collList[num].userAnswer==item.option&&item.rightFlag!=1?'worrychose':'']"
                                            >{{ item.option }}</span>
                                        </div>
                                        <div
                                            class="rightchose"
                            ...
                            <!-- 判断 -->
                            <div
                                v-if="collList[num].questionType.type==5"
                            >
                                <div v-if="collList[num].userAnswer==null || collList[num].userAnswer==''">
                                    <div
                                        v-for="(item,n) in collList[num].answerList"
                                        :key="n"
                                        class="singlecontent"
                                        ...
                                        <div>
                                            <span
                                                ...
                                                :class="{judge1: item.rightFlag == 1,
                                                         judge0: item.rightFlag == 0 && collList[num].userAnswer == item.option}"
                                            ></span>
                                        </div>
                                        <div
                                            class="rightchose"
                                            :class="{leftchose2: item.rightFlag == 1,
                                                     worrychose1: item.rightFlag == 0 && collList[num].userAnswer == item.option}"
                                        >
                                            <span v-html="item.content"></span>
                                        </div>
                                    </div>
                            ...
                            <!-- 多选和不定选 -->
                            <div
                                v-if="collList[num].questionType.type==1||collList[num].questionType.type==2"
                            >
                                <!-- 用户未做 -->
                                <div v-if="collList[num].userAnswer==null">
                                    <div
                                ...
                                <div v-else>
                                    ...
                                    >
                                        <div>
                                            <span
                                                class="chose"
                                                :class="[item.rightFlag==1?'leftchose':'',collList[num].userAnswer!==collList[num].rightAnswer&&item.rightFlag==0?'worrychose':'']"
                                            >{{ item.option }}</span>
                                        </div>
                                        <div
                                            class="rightchose"
                                            :class="[item.rightFlag==1?'leftchose2':'',collList[num].userAnswer!==collList[num].rightAnswer&&item.rightFlag==0?'worrychose1':'']"
                                        >
                                            <span v-html="item.content" />
                                        </div>
                                    </div>
                            ...
                            <!-- 材料简答题 -->
                            <div v-if="collList[num].questionType.type==4">
                                <div>您的答案:{{ collList[num].userAnswer }}</div>
                            </div>
                            <!-- 填空题 -->
                            <div
                                v-if="collList[num].questionType.type==3"
                            >
                                <div
                                    v-for="(item,n) in collList[num].answerList"
                                    :key="n"
                            ...
                            <transition name="slide-fade">
                                <div class="analysis">
                                    <div class="stem">
                                        <span>参考答案：</span>
                                        <!-- <span
                                        v-for="(items,m) in collList[num].answerList"
                                        :key="m"
                                        class="rightchose2"
                                    >{{ items.rightFlag==1? items.option : "" }}</span>
                                    <span class="userAnswer">您的答案：{{ collList[num].questionType.type == 5?"": collList[num].userAnswer }}</span> -->
                                        <div
                                            v-if="collList[num].questionType.type!=='5'"
                                        >
                                            <span
                                        ...
                                        <div v-if="collList[num].questionType.type=='5'">
                                            <span
                                                v-for="(items,m) in collList[num].answerList"
                                                :key="m"
                                                class="rightchose2"
                                    ...
                                    <div v-if="!anajudge" class="anadetails">
                                        ...
                                        <div v-html="collList[num].analysis" />
                                    </div>
                                </div>
                            </transition>
                        </div>
                    ...
                    <div v-else class="mainLeft">
                        <div class="pageTitle">我的收藏重做</div>
                        <div class="stem">
                            <span class="questiontype">{{ num+1 }}.</span>
                            <span v-html="collList[num].stem" />
                        </div>
                        <div class="content">
                                ...
                                <div v-if="collList[num].userAnswer==null">
                                    ...
                                    >
                                        <div>
                                            <span
                                                class="chose"
                                            >{{ collList[num].questionType.type==5?"":item.option }}</span>
                                        </div>
                                        <div class="rightchose">
                                            <span v-html="item.content"></span>
                                        </div>
                            ...
                            >
                                ...
                                <div v-else>
                                    ...
                                    >
                                        <div>
                                            <span
                                                class="chose"
                                                :class="getItemType(item,collList[num])"
                                            >{{ item.option }}</span>
                                        </div>
                                        <div
                                            class="rightchose"
                                ...
                                <div>
                                    <div
                                        v-if="collList[num].userAnswer==null"
                                        class="btn"
                            ...
                            <!-- 材料简答题 -->
                            <div v-if="collList[num].questionType.type==4">
                                <div v-if="!(collList[num] || {}).submit">
                                    <div class="myinput">
                                        <el-input
                                            v-model="collList[num].userAnswer"
                                            type="textarea"
                                    ...
                                    <div>
                                        <div
                                            class="btn"
                                            @click="jdpost(collList[num])"
                                        >
                                            确认答案
                                        </div>
                                    </div>
                                </div>
                                <div v-else>您的答案:{{ collList[num].userAnswer }}</div>
                            </div>
                            <!-- 填空题 -->
                            <div v-if="collList[num].questionType.type==3">
                                <div v-if="collList[num].userAnswer==''">
                                    <div class="myinput">
                                        <el-input
                                            v-model="textarea2"
                                            type="textarea"
                        ...
                        <transition name="slide-fade">
                            <div v-if="anajudge" class="analysis">
                                ...
                                <div class="anadetails">
                                    ...
                                    <div v-html="collList[num].analysis"></div>
                                </div>
                            </div>
                        </transition>
                        <div class="bot">
...
import { myColTestList, Collection, submiterror } from "../action";
...
export default {
    ...
    mounted() {
        ...
        myColTestList({
            ...
            if (res !== "") {
                ...
                this.flag = true;
                this.collList = res;
                // console.log(this.collList.length, 476476476)
                this.testNum = this.collList.length; // 总题数
                // console.log(this.testNum, 478478478478);

                let collect = [];
                res.forEach(questionitem => {
                    // console.log(questionitem, 1111);
    ...
    methods: {
        ...
        postjc() {
            ...
            const num = this.num;
            const categoryId = this.collList[num].categoryId;
            const chapterId = this.collList[num].chapterId;
            const questionId = this.collList[num].id;
            submiterror({
                categoryId,
                chapterId,
                questionId,
        ...
        singlechose(n) {
            // 单选
            let num = this.num;
            this.collList[num].answerList.map((item, m) => {
                item.checked = false;
            });
            this.collList[num].answerList[n].checked = true;
            this.collList[num].userAnswer = this.collList[num].answerList[
                n
            ].option;
            var right = this.collList[num].answerList.filter((item, n) => {
                // 获取正确选项
        ...
        doublechose(n) {
            ...
            var num = this.num;
            this.$set(
                this.collList[num].answerList[n],
                "checked",
                !this.collList[num].answerList[n].checked
            );
        },
        doublepost(n) {
            var num = this.num;
            var middel = []; // 多选题用户选择的所有答案
            var lists = this.collList[num].answerList.filter((item, n) => {
                return item.checked;
            });
            ...
            this.collList[num].userAnswer = middel;
            if (this.collList[num].userAnswer != "") {
                this.anajudge = true;
            }
        },
        changeana() {
        ...
        next() {
            ...
            let num = this.num;
            // console.log(this.collList[num], 644644444444)
            if (this.collList[num].userAnswer == null) {
                this.anajudge = false;
            } else {
                this.anajudge = true;
            }
        ...
        collecting(n) {
            ...
            let chapterId = this.$route.query.item.chapterId; // 章节id
            let categoryId = this.userInfor.id; // 科目id
            var questionId = this.collList[num].id;
